...
hi = subplot(3,1,1);
plot(time_out(start_index:out_count),y_out(start_index:out_count,1)','-o',time_out(start_index:out_count),y_out(start_index:out_count,2)','-o');
...
hi = subplot(3,1,2);
plot(time_out(start_index:out_count),y_out(start_index:out_count,3)','--o',time_out(start_index:out_count),y_out(start_index:out_count,4)','-o');
hi = subplot(3,1,3);
plot(time_out(start_index:out_count),y_out(start_index:out_count,5)','--o',time_out(start_index:out_count),y_out(start_index:out_count,6)','-o');
pause(1.0);
